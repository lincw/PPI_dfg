...
We request funding for one doctoral researcher (PhD Student, TV-L 13, 65\%) for the project duration:

\position{Doctoral Researcher (TV-L 13, 65\%), 36 months}{152100}

\textit{Justification:} The doctoral researcher will be responsible for the implementation of the computational pipelines, including data integration, LLM inference management on the Mac Studio, and GNN model training. This position offers an excellent opportunity for doctoral training at the intersection of Artificial Intelligence and Systems Biology. The Principal Investigator (100\%) will provide intensive supervision and lead the higher-level biological reasoning and project coordination.
...
We request a full-time position for the Principal Investigator (Eigene Stelle) for 36 months. Total requested: \textbf{252,000\,\euro}.
